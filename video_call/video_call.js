        ...
        case constants.startCall:
            ...
            if (channelName != null && userId != null) {
                if (channels.includes(channelName) && !channels[channelName].hasOwnProperty(userId)) {
                    ...
                    videoCallStarted(connection, channelName, userId)
                ...
                sendTo(connection, {
                    type: constants.failedToJoinVideoCall,
                    data: { 'success': false }
                });
            }
            break;
...
function videoCallStarted(connection, channelName, userId) {
    sendTo(connection, {
        type: constants.videoCallStarted,
